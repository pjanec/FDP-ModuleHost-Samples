    ...
    public class MultiInstanceTests
    {
        ...
        public void WeaponStateTranslator_Ingress_MultipleInstances_StoresIndependently()
        {
            ...
            var samples = new List<IDataSample>
            {
                new MockDataSample 
                { 
                    Data = new ModuleHost.Network.Cyclone.Topics.WeaponStateDescriptor { EntityId = 100, InstanceId = 0, AmmoCount = 10 },
                    InstanceId = 0
                },
                new MockDataSample 
                { 
                    Data = new ModuleHost.Network.Cyclone.Topics.WeaponStateDescriptor { EntityId = 100, InstanceId = 1, AmmoCount = 20 },
                    InstanceId = 1
                }
            };
        ...
        public void WeaponStateTranslator_Egress_OnlyPublishesOwnedInstances()
        {
            ...
            // Add to map so translator can find it
            map[100] = entity;
