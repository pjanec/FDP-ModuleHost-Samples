...
namespace ModuleHost.Network.Cyclone.Tests.Integration
{
    public class ReliableInitializationTests
    {
        ...
        public void StaticTopology_GetExpectedPeers_ExcludesLocalNode()
        {
            ...
            var peers = topo.GetExpectedPeers(ReliableInitType.AllPeers);
        ...
        public void StaticTopology_SingleNode_ReturnsEmpty()
        {
            ...
            var peers = topo.GetExpectedPeers(ReliableInitType.None);
            Assert.Empty(peers);
        }
        ...
        public void Translator_Ingress_CallsGateway()
        {
            ...
            var msg = new ModuleHost.Network.Cyclone.Topics.EntityLifecycleStatusDescriptor 
            { 
                NodeId = 2, 
                EntityId = 999, 
            ...
            Assert.Empty(cmd.Acks);
             ...
             var msg2 = new ModuleHost.Network.Cyclone.Topics.EntityLifecycleStatusDescriptor 
            { 
                NodeId = 3, 
                EntityId = 999, 
                State = EntityLifecycle.Active 
        ...
        public void Translator_Ingress_MultipleMessages_AllProcessed()
        {
            ...
            var reader = new MockDataReader(
                new ModuleHost.Network.Cyclone.Topics.EntityLifecycleStatusDescriptor { NodeId = 2, EntityId = 100, State = EntityLifecycle.Active },
                new ModuleHost.Network.Cyclone.Topics.EntityLifecycleStatusDescriptor { NodeId = 2, EntityId = 200, State = EntityLifecycle.Active }
            );
